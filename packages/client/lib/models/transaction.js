...
module.exports = class Transaction {
  constructor (transaction) {
    ...
    ['id', 'version', 'timestamp', 'senderPublicKey', 'recipientId', 'type', 'vendorFieldHex', 'amount', 'fee', 'blockId', 'signature', 'secondSignature', 'asset'].forEach((key) => { // eslint-disable-line max-len
