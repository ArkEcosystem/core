  ...
  transaction = {
    ...
    asset: {
      payments: [{
        ...
        amount: Bignum.from(20)
      }, {
        amount: Bignum.from(30)
      }, {
        amount: Bignum.from(40)
      }, {
        amount: Bignum.from(50)
      }]
    }
  }
})
...
describe('MultiPaymentHandler', () => {
  ...
  describe('canApply', () => {
    ...
    it('should be ok', () => {
      const amount = transaction.asset.payments.reduce((a, p) => (a.add(p.amount)), Bignum.ZERO)
