...
import { IMultiSignatureAsset, ISerializeOptions } from "../../../interfaces";
...
export class MultiSignatureRegistrationTransaction<T, U extends ITransactionData, E> extends Transaction<T, U, E> {
