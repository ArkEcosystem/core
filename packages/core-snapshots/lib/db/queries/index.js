...
module.exports = {
  blocks: {
    ...
    deleteFromHeight: loadQueryFile(
      __dirname,
      './blocks/delete-from-height.sql',
    ),
  },
  transactions: {
    timestampRange: loadQueryFile(
      __dirname,
      './transactions/timestamp-range.sql',
    ),
    timestampHigher: loadQueryFile(
      __dirname,
      './transactions/timestamp-higher.sql',
    ),
    deleteFromTimestamp: loadQueryFile(
      __dirname,
      './transactions/delete-from-timestamp.sql',
    ),
  },
  rounds: {
