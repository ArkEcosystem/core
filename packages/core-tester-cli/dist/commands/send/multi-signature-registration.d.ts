...
export declare class MultiSignatureRegistrationCommand extends SendCommand {
    static description: string;
    static flags: {
        multiSignatureFee: flags.IOptionFlag<number>;
        participants: flags.IOptionFlag<string>;
        passphrases: flags.IOptionFlag<string>;
