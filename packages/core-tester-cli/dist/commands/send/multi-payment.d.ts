...
export declare class MultiPaymentCommand extends SendCommand {
    static description: string;
    static flags: {
        multipaymentFee: flags.IOptionFlag<number>;
        recipients: flags.IOptionFlag<string>;
        amounts: flags.IOptionFlag<string>;
