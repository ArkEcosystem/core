...
module.exports = class PostgresConnection extends ConnectionInterface {
  ...
  async getActiveDelegates (height, delegates) {
    ...
    if (this._activeDelegates && this._activeDelegates.length && this._activeDelegates[0].round === round) {
      return this._activeDelegates
    }
    ...
    this._activeDelegates = delegates.map(delegate => {
