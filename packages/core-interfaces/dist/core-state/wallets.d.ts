...
export declare type WalletIndexer = (index: IWalletIndex, wallet: IWallet) => void;
...
export declare type IWalletMultiSignatureAttributes = Interfaces.IMultiSignatureAsset & {
    legacy?: boolean;
};
