...
describe("Connection", () => {
    ...
    describe("addTransactions", () => {
        ...
        it("should not add not-appliable transactions", () => {
            ...
            const highFeeTransaction = Transaction.from(mockData.dummy3).data;
    ...
    describe("addTransactions with expiration", () => {
        it("should add the transactions to the pool and they should expire", async () => {
            ...
            transactions.push(Transaction.from(mockData.dummyExp1));
            transactions[transactions.length - 1].expiration = expiration;

            transactions.push(Transaction.from(mockData.dummy1));

            // Workaround: Increase balance of sender wallet to succeed
            const insufficientBalanceTx: any = Transaction.from(mockData.dummyExp2);
    ...
    describe("acceptChainedBlock", () => {
        ...
        it("should remove transaction from pool if it's in the chained block", () => {
            const transaction0 = Transaction.from(block2.transactions[0]);
    ...
    describe("senderHasTransactionsOfType", () => {
        ...
        it("should be true for existent sender with votes", () => {
            ...
            const voteTx = Transaction.from(tx);
    ...
    describe("stress", () => {
        ...
        it("multiple additions and retrievals", () => {
            ...
            for (let i = 0; i < testSize; i++) {
                const transaction = Transaction.from(mockData.dummy1);
        ...
        it("add many then get first few", () => {
            ...
            const topFeesReceived = topTransactionsSerialized.map(e => Transaction.from(e).fee.toString());
