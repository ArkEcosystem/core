...
import { Interfaces as CryptoInterfaces, Interfaces, Transactions, Types } from "@arkecosystem/crypto";
...
export class EntityTransactionHandler extends Handlers.TransactionHandler {
    ...
    public async throwIfCannotBeApplied(
        ...
        const staticFee = this.getConstructor().staticFee(this.cryptoManager);
