...
export class Controller {
    ...
    protected readonly blockchain = app.get<Contracts.Blockchain.IBlockchain>("blockchain");
    protected readonly databaseService = app.get<Contracts.Database.IDatabaseService>("database");
