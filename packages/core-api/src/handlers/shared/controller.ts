...
export class Controller {
    ...
    protected readonly blockchain = app.get<Contracts.Blockchain.Blockchain>("blockchain");
    protected readonly databaseService = app.get<Contracts.Database.DatabaseService>("database");
