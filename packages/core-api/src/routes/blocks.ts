            ...
            validate: {
                ...
                payload: Joi.object({
                    ...
                    criteria: Joi.array().items(
                        ...
                        server.app.schemas.searchCriteria("version", Joi.number().integer().min(0), [
                            "equal",
                            "in",
                            "like",
                            "lessThanEqual",
                        ...
                        server.app.schemas.searchCriteria("generatorPublicKey", Joi.string().hex().length(66), [
                            "equal",
                            "in",
                            "like",
                        ]),
                        server.app.schemas.searchCriteria("blockSignature", Joi.string().hex().max(144), [
                            "equal",
                            "in",
                            "like",
                        ]),
                        server.app.schemas.searchCriteria("timestamp", Joi.number().integer().min(0), [
                            "equal",
                            "in",
                            "like",
                            "lessThanEqual",
