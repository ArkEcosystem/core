...
export const blockQueryLevelOptions = [
    ...
    { field: "numberOfTransactions", asc: true, desc: true, allowSecondOrderBy: false, diverse: false },
    { field: "totalAmount", asc: true, desc: true, allowSecondOrderBy: false, diverse: false },
    { field: "totalFee", asc: true, desc: true, allowSecondOrderBy: false, diverse: false },
