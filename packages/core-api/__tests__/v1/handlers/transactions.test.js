...
describe('API 1.0 - Transactions', () => {
  ...
  describe('GET /transactions/get?id=', () => {
    it('should be ok using valid id', async () => {
      ...
      expect(response.data.transaction).toHaveProperty('amount', transactionInCheck.amount.toNumber())
      expect(response.data.transaction).toHaveProperty('fee', transactionInCheck.fee.toNumber())
