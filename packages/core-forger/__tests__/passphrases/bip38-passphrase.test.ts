import { Bip38Passphrase } from "@packages/core-forger/src/passphrases/bip38-passphrase";
...
describe("Bip38Passphrase", () => {
    it("should pass with a valid password", () => {
        const bip38Passphrase = new Bip38Passphrase(bip38, "bip38-password");
    ...
    it("should fail with an invalid password", () => {
        expect(() => new Bip38Passphrase(bip38, "invalid-password")).toThrow();
    });
