...
export class BusinessUpdateTransaction<T, U extends Interfaces.ITransactionData, E> extends Transactions.Transaction<
    T,
    U,
    E
> {
    ...
    protected static defaultStaticFee = MagistrateTransactionStaticFees.BusinessUpdate;
