...
beforeAll(async () => {
    ...
    block3 = bip39.forge([voteUnvoteTransaction.data], {
...
describe("BlockState handling unvote, vote+unvote transactions", () => {
    ...
    it("should apply block#3 containing single vote+unvote transaction", async () => {
        const delegate10 = walletRepository.findByPublicKey(delegates[10].publicKey);
    ...
    it("should revert block#3 containing single vote+unvote transaction", async () => {
        const delegate10 = walletRepository.findByPublicKey(delegates[10].publicKey);
