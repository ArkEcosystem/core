...
describe("Block", () => {
    ...
    test("#fromHex", () => {
        expectBlock(Block.fromHex(Block.serializeWithTransactions(dummyBlock).toString("hex")));
    });

    test("#fromBytes", () => {
        expectBlock(Block.fromBytes(Block.serializeWithTransactions(dummyBlock)));
    });
    ...
    describe("constructor", () => {
        ...
        it("should construct the block (header only)", () => {
            const block = Block.fromHex(dummyBlock2.serialized);
        ...
        it("should construct the block (full)", () => {
            const block = Block.fromHex(dummyBlock2.serializedFull);
            const actual = block.toJson();
    ...
    describe("getHeader", () => {
        it("returns the block data without the transactions", () => {
            ...
            const data2 = { ...data };
            const header = Block.fromData(data2).getHeader();
    ...
    describe("serializeWithTransactions", () => {
        ...
        describe("should validate hash", () => {
            ...
            const block1 = Block.fromData(dummyBlock);
            const block2 = Block.fromData(Block.deserialize(serialized));
    ...
    describe("should reorder correctly transactions in deserialization", () => {
        ...
        const block = Block.fromData(issue);
    ...
    describe("v1 fix", () => {
        ...
        describe("apply v1 fix", () => {
            ...
            it("should process a matching id", () => {
                ...
                const blk2 = Block.fromData(mock2);
