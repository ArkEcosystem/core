...
export const makeDummyBlock = (cryptoManager: CryptoSuite.CryptoManager) => ({
    ...
    totalAmount: cryptoManager.LibraryManager.Libraries.BigNumber.make("10500000000"),
    totalFee: cryptoManager.LibraryManager.Libraries.BigNumber.make("70000000"),
    reward: cryptoManager.LibraryManager.Libraries.BigNumber.make("200000000"),
    payloadLength: 224,
    ...
    transactions: [
        {
            ...
            fee: cryptoManager.LibraryManager.Libraries.BigNumber.make("10000000"),
            amount: cryptoManager.LibraryManager.Libraries.BigNumber.make("1300000000"),
            expiration: 0,
        ...
        },
        {
            ...
            senderPublicKey: "03287bfebba4c7881a0509717e71b34b63f31e40021c321f89ae04f84be6d6ac37",
            fee: cryptoManager.LibraryManager.Libraries.BigNumber.make("10000000"),
            amount: cryptoManager.LibraryManager.Libraries.BigNumber.make("1700000000"),
            expiration: 0,
            recipientId: "DBYyh2vXcigrJGUHfvmYxVxEqeH7vomw6x",
            signature:
        ...
        },
        {
            ...
            senderPublicKey: "03287bfebba4c7881a0509717e71b34b63f31e40021c321f89ae04f84be6d6ac37",
            fee: cryptoManager.LibraryManager.Libraries.BigNumber.make("10000000"),
            amount: cryptoManager.LibraryManager.Libraries.BigNumber.make("1500000000"),
            expiration: 0,
            recipientId: "DBYyh2vXcigrJGUHfvmYxVxEqeH7vomw6x",
            signature:
        ...
        },
        {
            ...
            senderPublicKey: "03287bfebba4c7881a0509717e71b34b63f31e40021c321f89ae04f84be6d6ac37",
            fee: cryptoManager.LibraryManager.Libraries.BigNumber.make("10000000"),
            amount: cryptoManager.LibraryManager.Libraries.BigNumber.make("1600000000"),
            expiration: 0,
            recipientId: "DBYyh2vXcigrJGUHfvmYxVxEqeH7vomw6x",
            signature:
        ...
        },
        {
            ...
            senderPublicKey: "03287bfebba4c7881a0509717e71b34b63f31e40021c321f89ae04f84be6d6ac37",
            fee: cryptoManager.LibraryManager.Libraries.BigNumber.make("10000000"),
            amount: cryptoManager.LibraryManager.Libraries.BigNumber.make("1200000000"),
            expiration: 0,
            recipientId: "DBYyh2vXcigrJGUHfvmYxVxEqeH7vomw6x",
            signature:
        ...
        },
        {
            ...
            senderPublicKey: "03287bfebba4c7881a0509717e71b34b63f31e40021c321f89ae04f84be6d6ac37",
            fee: cryptoManager.LibraryManager.Libraries.BigNumber.make("10000000"),
            amount: cryptoManager.LibraryManager.Libraries.BigNumber.make("1800000000"),
            expiration: 0,
            recipientId: "DBYyh2vXcigrJGUHfvmYxVxEqeH7vomw6x",
            signature:
        ...
        },
        {
            ...
            senderPublicKey: "03287bfebba4c7881a0509717e71b34b63f31e40021c321f89ae04f84be6d6ac37",
            fee: cryptoManager.LibraryManager.Libraries.BigNumber.make("10000000"),
            amount: cryptoManager.LibraryManager.Libraries.BigNumber.make("1400000000"),
            expiration: 0,
            recipientId: "DBYyh2vXcigrJGUHfvmYxVxEqeH7vomw6x",
            signature:
...
export const makeDummyBlock2 = (cryptoManager: CryptoSuite.CryptoManager) => ({
    data: makeDummyBlock(cryptoManager),
    serialized:
...
export const makeDummyBlock3 = (cryptoManager: CryptoSuite.CryptoManager) => ({
    id: "7242383292164246617",
    version: 0,
    timestamp: 46583338,
    height: 3,
    reward: cryptoManager.LibraryManager.Libraries.BigNumber.make("0"),
    previousBlock: "17882607875259085966",
    numberOfTransactions: 0,
    totalAmount: cryptoManager.LibraryManager.Libraries.BigNumber.make("0"),
    totalFee: cryptoManager.LibraryManager.Libraries.BigNumber.make("0"),
    payloadLength: 0,
