...
import { CurrentDelegateRemoteAction } from "@packages/core-forger/src/remote-actions/current-delegate";

let sandbox: Sandbox;
let action: CurrentDelegateRemoteAction;
...
beforeEach(() => {
    ...
    action = sandbox.app.resolve(CurrentDelegateRemoteAction);
});
