...
import { WalletsError, WalletIndexAlreadyRegisteredError, WalletIndexNotFoundError } from "@packages/core-state/src/wallets/errors";
...
describe("WalletErrors", () => {
    it("should construct base wallet error", () => {
        ...
        expect(() => { throw error}).toThrow(message);
    ...
    it("should construct WalletIndexAlreadyRegisteredError", () => {
        ...
        expect(() => { throw error}).toThrow(`The wallet index is already registered: ${message}`);
        expect(error.stack).toBeDefined();
    });
    ...
    it("should construct WalletIndexNotFoundError", () => {
        ...
        expect(() => { throw error}).toThrow(`The wallet index does not exist: ${message}`);
        expect(error.stack).toBeDefined();
    });
});