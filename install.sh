...
echo 'alias viper="$HOME/core-bridgechain/packages/core/bin/run"' >> ~/.bashrc

rm -rf "$HOME/core-bridgechain"
git clone "https://github.com/Purple90/core" "$HOME/core-bridgechain" || FAILED="Y"
if [ "$FAILED" == "Y" ]; then
    echo "Failed to fetch core repo with origin 'https://github.com/Purple90/core'"
...
rm -rf "$HOME/.config/@viper"
rm -rf "$HOME/.config/@viper"
rm -rf "$HOME/.config/viper-core"
