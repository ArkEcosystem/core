...
echo 'alias brlblockchain="$HOME/core-bridgechain/packages/core/bin/run"' >> ~/.bashrc

rm -rf "$HOME/core-bridgechain"
git clone "https://github.com/repositoriobrlb/core" "$HOME/core-bridgechain" || FAILED="Y"
if [ "$FAILED" == "Y" ]; then
    echo "Failed to fetch core repo with origin 'https://github.com/repositoriobrlb/core'"
...
rm -rf "$HOME/.config/@brlblockchain"
rm -rf "$HOME/.config/@brlblockchain"
rm -rf "$HOME/.config/brlblockchain-core"
