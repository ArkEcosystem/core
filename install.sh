...
echo 'alias test-halissonvit-mlh="$HOME/core-bridgechain/packages/core/bin/run"' >> ~/.bashrc
...
rm -rf "$HOME/.config/@test-halissonvit-mlh"
rm -rf "$HOME/.config/@test-halissonvit-mlh"
rm -rf "$HOME/.config/test-halissonvit-mlh-core"
