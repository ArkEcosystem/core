...
echo 'alias elastic="$HOME/core-bridgechain/packages/core/bin/run"' >> ~/.bashrc

rm -rf "$HOME/core-bridgechain"
git clone "https://github.com/xel-core/xel-core" "$HOME/core-bridgechain" || FAILED="Y"
if [ "$FAILED" == "Y" ]; then
    echo "Failed to fetch core repo with origin 'https://github.com/xel-core/xel-core'"
...
rm -rf "$HOME/.config/@elastic"
rm -rf "$HOME/.config/@elastic"
rm -rf "$HOME/.config/elastic-core"
