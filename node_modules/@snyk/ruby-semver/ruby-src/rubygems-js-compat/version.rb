...
# Class name flattened from Gem::Version to simplify compiled JavaScript
class GemVersion
  ...
  ANCHORED_VERSION_PATTERN = /^\s*(#{GemVersion::VERSION_PATTERN})?\s*$/
  ...
  def <=> other
    return unless GemVersion === other
