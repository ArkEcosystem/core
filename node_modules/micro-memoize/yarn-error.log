Arguments: 
  /usr/bin/node /usr/bin/yarn test:coverage
...
npm manifest: 
  {
    ...
    "scripts": {
      ...
      "prepublish:compile":
        "npm run lint && npm run flow && npm run test:coverage && npm run clean && npm run transpile:lib && npm run transpile:es && npm run build",
      "start": "npm run dev",
...
Lockfile: 
  ...
  eslint-config-rapid7@^2.11.1:
    version "2.11.1"
    resolved "https://registry.yarnpkg.com/eslint-config-rapid7/-/eslint-config-rapid7-2.11.1.tgz#358b2f2448cfbcc5f3fe0d0c5089236f68f17032"
    dependencies:
  ...
  fast-equals@^1.2.1:
    version "1.2.1"
    resolved "https://registry.yarnpkg.com/fast-equals/-/fast-equals-1.2.1.tgz#aa1926b828213df4b528bfd9e21b17ba1c7d34cb"
  ...
  hash-it@^3.1.2:
    version "3.1.2"
    resolved "https://registry.yarnpkg.com/hash-it/-/hash-it-3.1.2.tgz#2f5231a497da726c65f0758060032e5a894a93ee"
    dependencies:
      json-prune "^1.1.0"
  ...
  lodash@^4.13.1, lodash@^4.14.0, lodash@^4.17.2, lodash@^4.17.3, lodash@^4.17.4, lodash@^4.17.5, lodash@^4.2.0, lodash@^4.3.0:
    version "4.17.5"
  ...
  supports-color@^5.0.0, supports-color@^5.1.0, supports-color@^5.3.0:
    version "5.3.0"
...
Trace: 
  ...
  Exit code: 1
  Command: sh
  Arguments: -c nyc --cache npm test
  Directory: /home/tquetano/git/micro-memoize
  Output:
