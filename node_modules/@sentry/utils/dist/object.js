...
function getWalkSource(value) {
    ...
    if (is_1.isEvent(value)) {
        ...
        try {
            source.target = is_1.isElement(value.target)
                ? misc_1.htmlTreeAsString(value.target)
        ...
        try {
            source.currentTarget = is_1.isElement(value.currentTarget)
                ? misc_1.htmlTreeAsString(value.currentTarget)
