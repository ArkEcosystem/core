...
export declare class Scope implements ScopeInterface {
     ...
     */
    protected _notifyEventProcessors(processors: EventProcessor[], event: Event | null, hint?: EventHint, index?: number): Promise<Event | null>;
    /**
     * @inheritDoc
     */
     ...
     * @inheritDoc
     */
    startSpan(parentSpan?: Span): Span;
    /**
     ...
     * @hidden
     */
    applyToEvent(event: Event, hint?: EventHint): Promise<Event | null>;
}
/**
