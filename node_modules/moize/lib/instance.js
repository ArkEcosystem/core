...
exports.augmentMoizeInstance = exports.addInstanceProperties = exports.addInstanceMethods = void 0;

var _utils = require("micro-memoize/lib/utils");
...
var addInstanceMethods = function addInstanceMethods(moized, _ref) {
  ...
  var findKeyIndex = (0, _utils2.createFindKeyIndex)(isEqual, isMatchingKey);
  ...
  moized.getStats = function () {
    ...
    return (0, _stats.getStats)(profileName);
  };
  ...
  moized.remove = function (key) {
    ...
    if (~keyIndex) {
      ...
      onCacheChange(moized.cache, moized.options, moized);
      (0, _maxAge.clearExpiration)(expirations, existingKey, true);
    }
  };
  ...
  moized.update = function (key, value) {
    ...
    if (~keyIndex) {
      var existingKey = moized.cache.keys[keyIndex];
      (0, _utils.orderByLru)(moized.cache.keys, existingKey, keyIndex);
      (0, _utils.orderByLru)(moized.cache.values, value, keyIndex);
      onCacheChange(moized.cache, moized.options, moized);
    }
  };
...
exports.addInstanceMethods = addInstanceMethods;
...
exports.addInstanceProperties = addInstanceProperties;
...
exports.augmentMoizeInstance = augmentMoizeInstance;