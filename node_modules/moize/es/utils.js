// constants
import { DEFAULT_OPTIONS } from './constants'; // types
...
export var findExpirationIndex = function findExpirationIndex(expirations, key) {
...
export var createFindKeyIndex = function createFindKeyIndex(isEqual, isMatchingKey) {
...
export var getArrayKey = function getArrayKey(key) {
...
export var mergeOptions = function mergeOptions(originalOptions, newOptions) {
